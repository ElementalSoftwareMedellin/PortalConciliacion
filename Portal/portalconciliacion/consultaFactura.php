...
<div class="inner">
	...
	<!-- Post -->
		<article class="box post post-excerpt">
			<header>
				<h2><a href="#">GESTIÓN DE FACTURAS</a></h2>
				<p>Facturas</p>
			</header>
			<p>
					<div class="centro">
...
<script src="tablaconsulta/jquery.jtableAdminWeb.js" type="text/javascript"></script>
...
var record;
	...
	$(document).ready(function () {
		...
		$('#DocsContainer').jtable({
			...
			actions: {
				listAction: 'listarconsultafactura.php?action=list&jtSorting=Id%20DESC&jtStartIndex=0&jtPageSize=20',
				createAction: 'listarconsultafactura.php?action=create',
				updateAction: 'listarconsultafactura.php?action=update',
				deleteAction: 'listarconsultafactura.php?action=delete',
				slistAction: 'null'
			},
			fields: {
				Id: {
				...
				Estado: {
					title: 'Estado',
					width: '20%',
					options: {'0':'SIN PAGAR','1':'<b>PAGO</b>'}
				}
			}
		...
		$("#txtBuscar").keyup(function()
		{
            ...
            actions: {
            			slistAction: 'listarconsultafactura.php?action=list&jtSorting=Id%20DESC&jtStartIndex=0&jtPageSize=10&buscar=' + $(this).val(),
            		}
        	});
		});
