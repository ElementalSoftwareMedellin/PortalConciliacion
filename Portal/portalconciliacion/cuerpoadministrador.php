...
<html>
	...
	<body>
		...
		<!-- Sidebar -->
			<div id="sidebar">
				<section>
					<?php echo "<b>ADMINISTRADOR</b><br> ID: ".$_SESSION["User_Active"]." <br>USUARIO: ".$_SESSION["User_Name"]."<br><b><a href='logout.php'>SALIR</a></b>";?>
				</section>
				<!-- Logo -->
				<nav>
					...
					<nav>
						<ul id="accordion" class="accordion">
							...
							<li><div class="link"><i class="fa fa-user"></i>PERSONAL<i class="fa fa-chevron-down"></i></div>
								<ul class="submenu">
									<li><a href="CrearCliente.php">ALUMNOS</a></li>
